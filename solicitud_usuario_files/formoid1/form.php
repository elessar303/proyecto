...
<form class="formoid-solid-blue" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:450px;min-width:150px" method="post"><div class="title"><h2>Solicitud</h2></div>
	<div class="element-multiple<?php frmd_add_class("multiple"); ?>"><label class="title"></label><div class="item-cont"><div class="large"><select data-no-selected="Nothing selected" name="multiple[]" multiple="multiple" >
		...
		<option value="Soporte Impresora">Soporte Impresora</option>
		<option value="Soporte PC">Soporte PC</option>
		<option value="Soporte Caja">Soporte Caja</option></select><span class="icon-place"></span></div></div></div>
